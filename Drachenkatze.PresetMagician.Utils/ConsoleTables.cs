...
namespace Drachenkatze.PresetMagician.Utils
{
    public class ConsoleTable
    {
        ...
        public void Write(Format format = Utils.Format.Default)
        {
            switch (format)
            {
                case Utils.Format.Default:
                    Console.WriteLine(ToString());
                    break;
                case Utils.Format.MarkDown:
                    Console.WriteLine(ToMarkDownString());
                    break;
                case Utils.Format.Alternative:
                    Console.WriteLine(ToStringAlternative());
                    break;
                case Utils.Format.Minimal:
