...
namespace Microsoft.DwayneNeed.MDI
{
    ...
    {
        public static RoutedCommand<AdjustWindowRectParameter> AdjustWindowRect =
            new RoutedCommand<AdjustWindowRectParameter>("SizeWindow", typeof(MdiCommands));
        ...
        public static RoutedCommand ActivatePreviousWindow =
            new RoutedCommand("ActivatePreviousWindow", typeof(MdiCommands));
