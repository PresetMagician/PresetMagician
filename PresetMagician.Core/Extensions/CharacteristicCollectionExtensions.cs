...
namespace PresetMagician.Core.Extensions
{
    ...
    {
        public static bool HasCharacteristic<T>(this T collection, Characteristic item)
            where T : ICollection<Characteristic>
        {
        ...
        public static bool IsEqualTo<T>(this T collection, ICollection<Characteristic> target,
            bool excludeIgnored = false) where T : ICollection<Characteristic>
        {
            if (target == null)
            {
                return false;
