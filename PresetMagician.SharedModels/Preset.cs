...
namespace SharedModels
{
    public class Preset : ChildAwareModelBase
    {
        ...
        public Preset()
        {
            ...
            _modesChangeNotificationWrapper.CollectionItemPropertyChanged += WrapperOnModesCollectionItemPropertyChanged;
            ...
            _typesChangeNotificationWrapper.CollectionItemPropertyChanged += WrapperOnTypesCollectionItemPropertyChanged;
        ...
        {
            if (e.IsNewValueMeaningful && e.PropertyName == nameof(PresetBank))
            {
                RaisePropertyChanged(nameof(BankPath));
            }
            
            if (e.IsNewValueMeaningful && _propertiesWhichModifyMetadata.Contains(e.PropertyName) && ShouldTrackChanges())
            {
        ...
        /// </summary>
        [Key] public string PresetId { get; private set; } = Guid.NewGuid().ToString();
        ...
        {
            get => PresetBank != null ? PresetBank.BankPath : "";
            set
            {
                if (Plugin != null)
                {
        ...
        public int PreviewNoteNumber
        {
            ...
            set { if (Equals(value, PreviewNote.NoteNumber)) return;PreviewNote.NoteNumber = value; RaisePropertyChanged(nameof(PreviewNoteNumber));}
        }
        #endregion
        ...
        public string SerializedUserModifiedMetadata
        {
            ...
            set => UserModifiedProperties = JsonConvert.DeserializeObject<HashSet<string>>(value);
        }
        
        /// <summary>
        /// Indicates if the preset has been changed since the last export.
        /// </summary>
        public bool ChangedSinceLastExport => IsMetadataModified || LastExportedPresetHash == null || LastExportedPresetHash != PresetHash;
