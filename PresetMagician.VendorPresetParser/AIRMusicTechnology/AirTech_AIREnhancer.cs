...
namespace PresetMagician.VendorPresetParser.AIRMusicTechnology
{
    ...
    [UsedImplicitly]
    public class AirTech_AIREnhancer : AirTech, IVendorPresetParser
    {
        public override List<int> SupportedPlugins => new List<int> {1752057153};
        ...
        protected override string GetParseDirectory()
        {
            return Path.Combine(
                ...
                @"AIR Music Technology\AIR Enhancer\Presets");
        }

        protected override Tfx.Tfx GetTfxParser()
        {
            return new TfxAIREnhancer();
        }
    }
}