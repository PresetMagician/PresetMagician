...
namespace PresetMagician.VendorPresetParser.AIRMusicTechnology
{
    ...
    [UsedImplicitly]
    public class AirTech_AIRFuzzWah : AirTech, IVendorPresetParser
    {
        public override List<int> SupportedPlugins => new List<int> {1750550081};
        ...
        protected override string GetParseDirectory()
        {
            return Path.Combine(
                ...
                @"AIR Music Technology\AIR Fuzz-Wah\Presets");
        }

        protected override Tfx.Tfx GetTfxParser()
        {
            return new TfxAIRFuzzWah();
        }
    }
}