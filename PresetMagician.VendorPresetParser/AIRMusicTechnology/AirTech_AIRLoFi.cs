...
namespace PresetMagician.VendorPresetParser.AIRMusicTechnology
{
    ...
    [UsedImplicitly]
    public class AirTech_AIRLoFi : AirTech, IVendorPresetParser
    {
        public override List<int> SupportedPlugins => new List<int> {1718570049};
        ...
        protected override string GetParseDirectory()
        {
            return Path.Combine(
                ...
                @"AIR Music Technology\AIR Lo-Fi\Presets");
        }

        protected override Tfx.Tfx GetTfxParser()
        {
            return new TfxAIRLoFi();
        }
    }
}