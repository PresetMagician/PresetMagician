...
namespace PresetMagician.VendorPresetParser.AIRMusicTechnology
{
    ...
    [UsedImplicitly]
    public class AirTech_AIRMULTI_Delay : AirTech, IVendorPresetParser
    {
        public override List<int> SupportedPlugins => new List<int> {1816415553};
        ...
        protected override string GetParseDirectory()
        {
            return Path.Combine(
                ...
                @"AIR Music Technology\AIR Multi-Delay\Presets");
        }

        protected override Tfx.Tfx GetTfxParser()
        {
            return new TfxAIRMULTI_Delay();
        }
    }
}