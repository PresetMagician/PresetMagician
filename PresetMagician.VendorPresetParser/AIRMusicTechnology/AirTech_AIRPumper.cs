...
namespace PresetMagician.VendorPresetParser.AIRMusicTechnology
{
    ...
    [UsedImplicitly]
    public class AirTech_AIRPumper : AirTech, IVendorPresetParser
    {
        public override List<int> SupportedPlugins => new List<int> {1886212161};
        ...
        protected override string GetParseDirectory()
        {
            return Path.Combine(
                ...
                @"AIR Music Technology\AIR Pumper\Presets");
        }

        protected override Tfx.Tfx GetTfxParser()
        {
            return new TfxAIRPumper();
        }
    }
}