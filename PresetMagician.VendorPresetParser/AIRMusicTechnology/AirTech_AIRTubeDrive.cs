...
namespace PresetMagician.VendorPresetParser.AIRMusicTechnology
{
    ...
    [UsedImplicitly]
    public class AirTech_AIRTubeDrive : AirTech, IVendorPresetParser
    {
        public override List<int> SupportedPlugins => new List<int> {1147294785};
        ...
        protected override string GetParseDirectory()
        {
            return Path.Combine(
                ...
                @"AIR Music Technology\AIR TubeDrive\Presets");
        }

        protected override Tfx.Tfx GetTfxParser()
        {
            return new TfxAIRTubeDrive();
        }
    }
}