    ...
    public class TfxDb33 : Tfx
    {
        ...
        public override void PostProcess()
        {
            ...
            using (var ms = new MemoryStream())
            {
                ...
                EndChunk = Resource1.Db33EndChunk
        ...
        public override byte[] GetBlockDataToWrite()
        {
            if (!MidiBlock.IsMagicBlock)
            {
                ...
                using (var ms = new MemoryStream())
                {
                    ...
                    //add block length
                    ms.Write(BigEndian.GetBytes(Resource1.Db33DefaultMidi.Length), 0, 4);
                    ms.Write(Resource1.Db33DefaultMidi, 0, Resource1.Db33DefaultMidi.Length);
